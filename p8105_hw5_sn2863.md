...
out study. This is because if we have a true value that is further away
from our null hypothesis value, then we would be more likely to reject
the null. Hence, power increases, as seen in the plot.

**Plots showing he average estimate vs the true value of mu, and the
average estimate of mu only in samples for which the null was rejected
vs the true value of mu.**
